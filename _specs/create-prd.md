...
4.  **Save PRD:** Save the generated document as `[n]-prd-[feature-name].md` inside the `./_specs/ai-tasks` directory. (Where `n` is a zero-padded 4-digit sequence starting from 0001, e.g., `0001-prd-user-authentication.md`, `0002-prd-dashboard.md`, etc.)
